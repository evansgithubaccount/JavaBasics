...
public class jBasics {
    ...
    public static void basicObjectCreator(){
        ...
        System.out.println("Charizard is level " + charizard.getLevel());  //references the getLegs method that returns the number of legs
        System.out.println("Have you caught this pokemon?: " + charizard.getCaught());
        System.out.println("This Pokemon is a " + charizard.getType() + " type");
    }

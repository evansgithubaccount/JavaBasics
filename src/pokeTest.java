...
public class pokeTest {
    ...
    public static int getOppLevel(int userLevel){
        Random rand = new Random();
        int oppLevel = (userLevel-(userLevel/4)) + rand.nextInt(userLevel/2);  //generates a random number that is within 25% of the userLevel
        return oppLevel;
    }
    ...
    public static void main(String[] args){
        ...
        switch(userChoice.toUpperCase()){
            ...
            case "PIKACHU": userPoke = new Pikachu(5);break;
        ...
        do{
            ...
            if(userResponse.toUpperCase().equals("G")){
                ...
                do{
                    ...
                    switch (userMove) {
                    case 1:
                        wildPokemon.takeDamage(userPoke.move1(userPoke.getLevel(), wildPokemon.getDEF(), wildPokemon.getType(),userPoke.getMove(0),userPoke.getMoveStrengths(0),userPoke.getNickname()),true);
                        break;
                    case 2:
                        wildPokemon.takeDamage(userPoke.move2(userPoke.getLevel(), wildPokemon.getDEF(),wildPokemon.getType(),userPoke.getMove(1),userPoke.getMoveStrengths(1),userPoke.getNickname()),true);
                        break;
                    default:
                ...
                switch(wildMoveChoice){
                    case 0: userPoke.takeDamage(wildPokemon.move1(wildPokemon.getLevel(),userPoke.getDEF(),userPoke.getType(),wildPokemon.getMove(0),wildPokemon.getMoveStrengths(0),wildPokemon.getName()),false);break;
                    case 1: userPoke.takeDamage(wildPokemon.move2(wildPokemon.getLevel(),userPoke.getDEF(),userPoke.getType(),wildPokemon.getMove(1),wildPokemon.getMoveStrengths(1),wildPokemon.getName()),false);break;
                    default:
